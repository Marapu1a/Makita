-- ============================================================
-- ВЫПОЛНЕНО: 2026-07-11 прод (после инцидента sequelize.sync). ИСТОРИЧЕСКИЙ ONE-SHOT СКРИПТ.
-- ПОВТОРНО НЕ ЗАПУСКАТЬ: база уже в целевом состоянии,
-- повторный прогон разрушителен. Хранится для истории/аудита.
-- ============================================================
